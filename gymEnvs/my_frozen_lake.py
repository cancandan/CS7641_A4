...
class MyFrozenLakeEnv(discrete.DiscreteEnv):
    """
    ...
    def __init__(self, desc=None, map_name="4x4", rewarding=True, step_reward=-0.0001, hole_reward=-10, is_slippery=True, equiProbable=True):
    ...
    def new_instance(self):
        return MyFrozenLakeEnv(desc=self.desc, rewarding=self.rewarding, step_reward=self.step_reward,
